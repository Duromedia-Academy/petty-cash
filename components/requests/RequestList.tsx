...
const RequestList = () => {
  ...
  const [selectedRequest, setSelectedRequest] =
    useState<PettyCashRequest | null>(null);
  ...
  const handleDelete = async () => {
    if (selectedRequest) {
      if (
        selectedRequest.requesterId === user?.uid ||
        role === "administrator"
      ) {
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            {(role === "administrator" ||
              role === "superior" ||
              role === "accountant") && <TableHead>Requester</TableHead>}
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56">
                    <DropdownMenuGroup>
                      ...
                      <DropdownMenuItem
                        className="text-destructive focus:text-white focus:bg-destructive space-x-3"
                        onClick={() => {
